...
// Gap (Non-AI): No bill pay integration
// No bill pay integration
import React, { useState } from 'react';

export default function GapNoBillPayIntegrationPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-bill-pay-integration/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No bill pay integration</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No bill pay integration</p>
