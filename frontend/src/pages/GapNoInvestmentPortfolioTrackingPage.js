...
// Gap (Non-AI): No investment portfolio tracking
// No investment portfolio tracking
import React, { useState } from 'react';

export default function GapNoInvestmentPortfolioTrackingPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-investment-portfolio-tracking/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No investment portfolio tracking</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No investment portfolio tracking</p>
