...
// Gap (Non-AI): No tax planning module
// No tax planning module
import React, { useState } from 'react';

export default function GapNoTaxPlanningModulePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-tax-planning-module/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No tax planning module</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No tax planning module</p>
