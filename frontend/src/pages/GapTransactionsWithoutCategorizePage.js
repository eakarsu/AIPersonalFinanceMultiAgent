...
// Gap (AI): Transactions without '/categorize
// Transactions without /categorize-transaction (auto-tag transaction category)
import React, { useState } from 'react';

export default function GapTransactionsWithoutCategorizePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-transactions-without-categorize/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Transactions without '/categorize</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Transactions without /categorize-transaction (auto-tag transaction category)</p>
